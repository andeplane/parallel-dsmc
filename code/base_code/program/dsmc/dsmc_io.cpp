    ...
    settings(system_->settings)
{
    ...
    if(system->myid==0) {
        ...
        velocity_distribution_file = fopen("statistics/velocity_distribution.txt","w");
        ...
        volumetric_flow_rate_file = fopen("statistics/volumetric_flow_rate.txt","w");
    }
}
